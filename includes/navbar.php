<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
  <div class="container" style="height: 50px; font-weight: bold">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      <form class="d-flex" action="index.php?'<?php echo $_GET['search']; ?>">
        ...
        ?>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu">
              ...
              <?php
              if ($_SESSION['email'] == 'maiphuocvinh@gmail.com') {
                echo "<li><a class='dropdown-item' href='admin.php?managecategory'>Manage Category</a></li>";
              }
              ?>
              <li>
