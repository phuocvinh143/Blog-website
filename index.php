...
<html lang="en">
  ...
  <body>
    ...
    <?php
      ...
      if ($total_posts == 0) {
        echo "<h3 style='margin: auto;'>No results found.</h3>";
      }
      ...
      <ul class="pagination justify-content-center">
        ...
        <?php
          for ($opage = 1; $opage <= $total_pages; $opage++){
            $color = "";
            if (isset($_GET['page']) && $opage == $_GET['page']) {
              $color = "active";
            }
        ?>
          <li class="page-item <?php echo $color; ?>">
            <a class="page-link" href="?<?php if(isset($_GET['search'])){echo "search=$keyword&";}?>page=<?=$opage?>">
              <?=$opage?>
            </a>
          </li>
        <?php 
